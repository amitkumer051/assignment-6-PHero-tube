...
const handleContent = async (categoryId) => {
    ...
    contentData.forEach(content => {
      if(content.length === 0){
        ...
        div.innerHTML = `
        <figure><img class="h-40 w-60" src="${content?.thumbnail}" alt="" /></figure>
        <div class="flex ">
        <div>
...
const totalSeconds = 14200;
const result = secondsToHours(totalSeconds);
console.log(`${result.hours}hrs ${result.minutes}min ago`);
